...
<tr>
	...
	<td>
	<input type="text" name="wpimageflow2_bgc" id="wpimageflow2_bgc" onkeyup="colorcode_validate(this, this.value);" value="<?php echo esc_html($options['bgcolor']); ?>">
...
<tr>
	...
	<td>
	<input type="text" name="wpimageflow2_txc" class="wpif2-color-field" value="<?php echo esc_html($options['txcolor']); ?>">
