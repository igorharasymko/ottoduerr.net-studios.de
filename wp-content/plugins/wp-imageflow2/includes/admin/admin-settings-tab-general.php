...
<tr>
	...
	<?php echo __('V2 (requires GD). DEPRECATED', 'wp-flow-plus'); ?>
	<br />
	<input type="radio" name="wpimageflow2_reflect" value="v3" <?php if ($options['reflect'] == 'v3') echo ' CHECKED'; ?> />
	<?php echo __('V3. Recommended only if you need transparent PNGs, GD version 2.0.28 strongly recommended. DEPRECATED', 'wp-flow-plus'); ?>
	<br />
	</td>
</tr>
<tr>
...
<tr>
	...
	<input type="checkbox" name="wpimageflow2_strict" value="strict" <?php if ($options['strict'] == 'true') echo ' CHECKED'; ?> /> 
		...
		<em><?php _e('This option is only applicable with V2 or V3 reflections: these settings are DEPRECATED.', 'wp-flow-plus'); ?></em>
	</td>
</tr>
</table>		